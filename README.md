...
git clone https://github.com/gabrielvitorcd/plataforma-estudo-ia.git
cd plataforma-estudo-ia
...
🔐	Autenticação Supabase (login, JWT)	✅
🧩	Integração FastAPI ↔ Supabase	✅
🧱	Sincronização automática de usuários	✅
📈	Módulo de progresso e sessões	🟡 Em desenvolvimento
🤖	Geração e correção de questões com IA	🔜
🏆	Gamificação e ranking de alunos	🔜
🔊	Text-to-Speech e modo offline	🔜
🧠 Visão Futura

A plataforma evoluirá para um sistema adaptativo completo, com:
...
IA de suporte por voz integrada.

💡 Aprender é se adaptar — e o futuro do aprendizado é inteligente.
...
💙 Feito com dedicação, café ☕ e muita curiosidade sobre IA.
